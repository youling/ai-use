...
| Work Context lifecycle / durable-before-fragile / fresh triggers (playbook) | `docs/SESSION_LIFECYCLE.md` §11 |
...
| Work Context lifecycle / durable-before-fragile / fresh triggers | `docs/SESSION_LIFECYCLE.md` §11 |
...
`docs/SESSION_LIFECYCLE.md` §11 是 Work Context lifecycle 的 current playbook；continuation 与完成边界的 authority 仍在 `docs/AGENT_INTERFACE.md`。早期模板说明如下：
