...
| `capability-lab` / L2 | Architect/Research；需要可复用 GitHub capability evidence 或当前 canary；仅证据 discovery，普通项目工作不默认读取 | [docs/research/github-capability-lab/README.md](research/github-capability-lab/README.md) |
