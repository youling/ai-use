...
| [`CONTEXT_MODE_SEED.md`](CONTEXT_MODE_SEED.md) | Human / Architect / Agent 层 | 上下文模式种子词：正交 context / mode / continuation / independence + 最小 delegation / parallelism 可复制契约（Context Lifecycle v0.1） |
