...
- [ADR-0006](ADR-0006_GITHUB_CAPABILITY_LAB.md) — GitHub Capability Lab evidence、fixture safety、currentness 与 owner-local adoption delta（R4 冻结裁决的文件化，待 exact-head Review）。
